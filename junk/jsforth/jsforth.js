...
/*
     FILE ARCHIVED ON 13:39:38 Jul 28, 2007 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:47:44 Mar 13, 2015.
...
//   if (document.domain.indexOf("forthfreak.net") == -1)  { version = -1 ; location.replace("/web/20070728133938/http://forthfreak.net/jsforth80x25.html") ; }
...
function wiki(pagename)  {
   loadurl("/web/20070728133938/http://wiki.forthfreak.net/index.cgi?" + pagename) ;
 }
...
function forthgpl()  { loadurl("/web/20070728133938/http://www.gnu.org/licenses/gpl.txt")  }
primitive("gpl",forthgpl) ;
describe("--",jsf) ;


function forthquickref()  { loadurl("/web/20070728133938/http://wiki.forthfreak.net/index.cgi?JavaScriptForthQuickReference")  }
primitive("quickref",forthquickref) ;
describe("--",jsf) ;


function tutorials() { loadurl("/web/20070728133938/http://wiki.forthfreak.net/index.cgi?ForthTutorials") }
primitive("tutorials",tutorials) ;
describe("--",jsf) ;


function andsoforth() { loadurl("/web/20070728133938/http://www.xs4all.nl/~thebeez/ForthPrimer/Forth_primer.html#tth_chAp2") }
primitive("AndSoForth",andsoforth) ;
describe("--",jsf) ;



function startingforth() { window.open("/web/20070728133938/http://wiki.forthfreak.net/index.cgi/?StartingForth") }
